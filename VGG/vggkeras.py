...
# filepath="vgg200_halffaces.best.hdf5"
...
# model.save('vgg200_halffaces.h5')
...
# plt.legend(['train', 'validate'], loc='upper left')
# plt.tight_layout()
# plt.savefig('vgg16_200_faces.png')



predict = []
model.load_weights("/media/srinath/Major Project/rotFace-masteroriginal/vgg200_halffaces.best.hdf5")
