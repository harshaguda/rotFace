...
# filepath="vgg_halffaces.best.hdf5"
...
# plt.legend(['train', 'validate'], loc='upper left')
# plt.tight_layout()
# plt.savefig('vgg16_faces.png')



predict = []
model.load_weights("/media/srinath/Major Project/rotFace-masteroriginal/vgg_halffaces.best.hdf5")
