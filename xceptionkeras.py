...
#model = load_model("/media/srinath/Major Project/Major/dummymobilenet.h5")
...
predict = []
model.load_weights("/media/srinath/Major Project/Major/xceptionweights.best.hdf5")
