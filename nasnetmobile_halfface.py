...
filepath="nasnet_halffaces_weights.best.hdf5"
...
model.save('nasnet_halffaces.h5')
print(history.history.keys())
plt.subplot(211)
plt.plot(history.history['acc'])
plt.plot(history.history['val_acc'])
plt.title('Accuracy for NASNet model')
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
plt.title('Loss for NASNet model')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.legend(['train', 'validate'], loc='upper left')
plt.tight_layout()
plt.savefig('nasnet_halffaces.png')





with open('nasnet.txt', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

model.load_weights("/home/rignitc/srinath/rotFace-masteroriginal/nasnet_halffaces_weights.best.hdf5")
predict = []
for i in range (1,23):
