...
#model = load_model("/media/srinath/Major Project/Major/mobilenetmajor.h5")
...
model.load_weights("/media/srinath/Major Project/Major/inceptionv3weights.best.hdf5")
predict = []
for i in range (1,3040):
    ...
    img = image.load_img("/media/srinath/Major Project/Major/test/%d.jpg"%i, target_size = (299,299)) #---->  KERAS WAY
    #print("%d.jpg"%i)
