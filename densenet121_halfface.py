...
base_model=DenseNet121(weights='imagenet',include_top=False, input_shape = (224, 224, 3), pooling = 'avg') #imports the mobilenet model and discards the last 1000 neuron layer.
...
filepath="densenet_halffaces_weights.best.hdf5"
...
model.save('densenet_halffaces.h5')
...
plt.legend(['train', 'validate'], loc='upper left')
plt.tight_layout()
plt.savefig('densenet_halffaces.png')


with open('densenet121.txt', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)


model.load_weights("/home/rignitc/srinath/rotFace-masteroriginal/densenet_halffaces_weights.best.hdf5")
predict = []
for i in range (1,23):
