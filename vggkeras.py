...
base_model=VGG16(weights='imagenet',include_top=False, input_shape = (224, 224, 3), pooling = 'avg') #imports the mobilenet model and discards the last 1000 neuron layer.
...
train_generator=train_datagen.flow_from_directory('/media/srinath/Major Project/Major/traindata', # this is where you specify the path to the main data folder
                                                 target_size=(224,224),
                                                 color_mode='rgb',
                                                 batch_size=32,
...
val_generator=train_datagen.flow_from_directory('/media/srinath/Major Project/Major/validate_03', # this is where you specify the path to the main data folder
                                                 target_size=(224,224),
                                                 color_mode='rgb',
                                                 batch_size=32,
                                                 class_mode='categorical',
...
#         epochs=20, validation_data = val_generator, validation_steps = val_steps, callbacks=callbacks_list)
...
# model.save('vggmajor20epochs.h5')
...
# plt.title('Loss for VGG16 model')
# plt.ylabel('loss')
# plt.xlabel('epoch')
# plt.legend(['train', 'validate'], loc='upper left')
# plt.tight_layout()
...
model.load_weights("/media/srinath/Major Project/Major/vgg16weights.best.hdf5")
#model = load_model("/media/srinath/Major Project/Major/vggmajor20epochs.h5")
predict = []
